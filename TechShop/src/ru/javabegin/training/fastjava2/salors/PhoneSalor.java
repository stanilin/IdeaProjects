 ...
 */
public class PhoneSalor {

    private String name;
    private String gender;

    public PhoneSalor(String name, String gender) {
        this.setName(name);
    ...
    public void consult() {
        System.out.println("Меня зовут " + getName() + ".Я Вас проконсультирую по интересующему Вас товару");
    }
